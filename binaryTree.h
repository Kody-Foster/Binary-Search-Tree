...
class binaryTreeType {
 public:
  ...
  void inorderTraversal(void (*userFunction)(nodeType<elemType>* p));
  void inorderTraversal() const;
  // Function to do an inorder traversal of the binary tree.
  // Postcondition: Nodes are printed in inorder sequence.

  void inorder(nodeType<elemType>* p, void (*userFunction)(nodeType<elemType>* p));
...
template <class elemType>
void binaryTreeType<elemType>::inorderTraversal(void (*userFunction)(nodeType<elemType>* p)) {
    inorder(this->root, userFunction);
}
...
template <class elemType>
void binaryTreeType<elemType>::inorder(nodeType<elemType>* p, void (*userFunction)(nodeType<elemType>* p)) {
    if (p != nullptr) {
        inorder(p->lLink);
        userFunction(p);
        cout << p->info << " ";
